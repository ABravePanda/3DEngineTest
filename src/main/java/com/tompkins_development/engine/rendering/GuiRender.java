...
import com.tompkins_development.engine.entity.GuiMesh;
...
public class GuiRender {
    ...
    public GuiRender(Window window) {
        ...
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("F:\\Engines\\3DEngineTest\\src\\main\\resources\\shaders\\gui.vert", GL_VERTEX_SHADER));
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("F:\\Engines\\3DEngineTest\\src\\main\\resources\\shaders\\gui.frag", GL_FRAGMENT_SHADER));
