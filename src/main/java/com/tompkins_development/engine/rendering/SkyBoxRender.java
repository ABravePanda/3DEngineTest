...
public class SkyBoxRender {
    ...
    public SkyBoxRender() {
        ...
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("F:\\Engines\\3DEngineTest\\src\\main\\resources\\shaders\\skybox.vert", GL_VERTEX_SHADER));
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("F:\\Engines\\3DEngineTest\\src\\main\\resources\\shaders\\skybox.frag", GL_FRAGMENT_SHADER));
